...
class CardDataSource {
    ...
    init() {
        ...
        cards += [
            Card(title:"제18회 임베디드SW경진대회 공고", source:"학부-학사 게시판", tag:["대회"], time: dateFormatter.date(from: "2020-05-14")!, color: UIColor.first, isVisited: true, url:"http://cs.hanyang.ac.kr/board/info_board.php?ptype=view&idx=28898&page=1&code=notice"),
            ...
            Card(title:"[KAIST] 2020년 몰입캠프 여름학기 모집", source: "학부-학사 게시판",tag:["모집"], time:  dateFormatter.date(from: "2020-05-11")!, color: UIColor.first, isVisited: true, url:"http://cs.hanyang.ac.kr/board/info_board.php?ptype=view&idx=28891&page=1&code=notice"),
            Card(title:"2020학년도 여름계절학기 수강신청 안내", source: "학부-학사 게시판",tag:["수강신청"], time:  dateFormatter.date(from: "2020-05-11")!, color: UIColor.first, isVisited: true, url:"http://cs.hanyang.ac.kr/board/info_board.php?ptype=view&idx=28890&page=1&code=notice"),
            ...
            Card(title:"2020-2학기 1차 국가근로장학금 학생신청기간 안내", source: "포털-장학 게시판",tag:["장학금"], time:  dateFormatter.date(from: "2020-05-18")!, color: UIColor.third, isVisited: true, url:"https://portal.hanyang.ac.kr/GjshAct/findGongjisahangs.do?pgmId=P308200&menuId=M006263&tk=0be29593626429dfc3f1b618045bc8172b86832df0d333bc0f5db47199b9028a", json: ["gongjiSeq":"15689"]),
