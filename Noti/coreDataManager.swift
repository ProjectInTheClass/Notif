...
class CoreDataManager{
    ...
    func setData() {
        ...
        if(lastUpdated.count == 0){
            ...
            CoreDataManager.shared.saveChannels(title: "공지사항게시판",subtitle: "공지사항", source: "학생생활관", color: .fifth, channelTags: [""], group: "한양대학교 학생생활관", isSubscribed: true){ onSuccess in print("saved = \(onSuccess)")}
            CoreDataManager.shared.saveChannels(title: "모집안내게시판",subtitle: "모집안내", source: "학생생활관", color: .fifth, channelTags: [""], group: "한양대학교 학생생활관", isSubscribed: true){ onSuccess in print("saved = \(onSuccess)")}
