...
struct ChannelViewController{
    ...
    init() {
        ...
        channels += [Channel(title: "학부-학사", subTitle: "컴퓨터소프트웨어학부", channelTags: ["대회","모집"]), Channel(title: "학부-취업", subTitle: "컴퓨터소프트웨어학부", channelTags: ["모집","채용"]), Channel(title: "포털-장학", subTitle: "한양포탈", channelTags: ["장학금"]), Channel(title: "포털-일반", subTitle: "한양포탈",channelTags: [] ),]
